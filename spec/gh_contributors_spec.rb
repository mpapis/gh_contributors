...
describe GhContributors do
  ...
  describe ".for_org" do
    ...
    it "requests the correct GitHub API resources" do
      GhContributors.for_org('railsinstaller')
    ...
    context ".data" do
      ...
      context ".first" do
        ...
        it "is a contributor" do
          contributor = GhContributors.for_org('railsinstaller').data.first
        ...
        context "zeroth element" do
          ...
          it "is contributor's name" do
            contributor_name = GhContributors.for_org('railsinstaller').data.first[0]
        ...
        context "first element" do
          ...
          it "is contributor's data" do
            contributor_hash = GhContributors.for_org('railsinstaller').data.first[1]

shared_examples_for 'load' do |object|
  ...
  before do
    ...
    stub_gh_get("/repos/railsinstaller/railsinstaller-windows/contributors").
      to_return(:body => fixture("contributors.json"))
    stub_gh_get("/repos/railsinstaller/website/contributors").
      to_return(:body => fixture("contributors.json"))
  end

  it "requests the correct GitHub API resources" do
    object.for_org('railsinstaller')
    expect(a_gh_get("/orgs/railsinstaller/repos")).to have_been_made
    expect(a_gh_get("/repos/railsinstaller/railsinstaller-nix/contributors")).to have_been_made
    expect(a_gh_get("/repos/railsinstaller/railsinstaller-windows/contributors")).to have_been_made
    expect(a_gh_get("/repos/railsinstaller/website/contributors")).to have_been_made
  end

  it "returns a GhContributors object" do
    contributors = object.for_org('railsinstaller')
  ...
  context ".data" do
    ...
    it "is an array" do
      data = object.for_org('railsinstaller').data
    ...
    context ".first" do
      ...
      it "is a contributor" do
        contributor = object.for_org('railsinstaller').data.first
      ...
      context "zeroth element" do
        ...
        it "is contributor's name" do
          contributor_name = object.for_org('railsinstaller').data.first[0]
      ...
      context "first element" do
        ...
        it "is contributor's data" do
          contributor_hash = object.for_org('railsinstaller').data.first[1]
          ...
          expect(contributor_hash["contributions"]).to eq 471
        end
